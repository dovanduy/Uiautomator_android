 ...
 */
public class case03_person_report extends base_testcase{
    public static int case_count=0;
    private final Marker MARKER= MarkerManager.getMarker("vivo");

    public case03_person_report(base_phone phone_in) {
        super(phone_in);
    }

    @Override
    public void during_run() throws Exception {
        function_name="个人报告_test";
        logger.info(MARKER, "Now is running function '{}'", function_name);
        my_phone.person_report_test();
    }
